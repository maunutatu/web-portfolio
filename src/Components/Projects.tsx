  ...
  return (
    <section>
      ...
      <Project name={'Blog App'} image={BlogAppImg}
        ...
        repositoryLink={'https://github.com/maunutatu/Blog_App'}/>
      <Project name={'Kanban Board App'} image={KanbanBoardAppImg}
        description={'A Kanban board -application, similar to likes of Trello and Microsoft Planner where users can create and use kanban boards. Kanban cards have different functionalities for following progress, schedule, attachments etc.'}
        tech={'Scala + JavaFX'} repositoryLink={'https://github.com/maunutatu/kanban-board-app'}/>
      <Project name={'Web Portfolio'} image={PorfolioImg}
        description={'This website is to showcase my web development skills. Includes 3D model animations and responsive web design.'}
